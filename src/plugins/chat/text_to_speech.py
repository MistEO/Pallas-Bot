...
tts_vocoder = config.TTS_VOCODER
BASE_DIR = Path(__file__).resolve().parent.parent.parent.parent
DEFAULT_MODEL_DIR = BASE_DIR / 'resource' / 'chat' / 'models'
AM_INFERENCE_DIR = BASE_DIR / 'resource' / 'tts' / 'models'
VOC_INFERENCE_DIR = AM_INFERENCE_DIR / 'vocoder'
nltk_data = AM_INFERENCE_DIR / "nltk_data"
...
voc_predictor = get_predictor(
    ...
    model_file=tts_vocoder + ".pdmodel",
    params_file=tts_vocoder + ".pdiparams",
    device=device)
